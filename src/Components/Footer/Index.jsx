    ...
    <footer className="w-full float-left overflow-hidden">
      <div className="pt-24 flex flex-col items-center justify-center relative bg-black text-white/90">
        ...
        >
          ...
          {/* Top Footer Section */}
          <div className="flex flex-wrap justify-center md:justify-between border-y border-white/10 py-9 my-9 xl:py-24 md:py-12 md:my-10">
            {/* Contact Info */}
            <div className="w-1/2 xl:w-1/6  mb-8 xl:mb-0 text-center md:text-left">
